...
import { createExpense } from "@firebaseAPI"
import { DateTimePickerAndroid } from "@react-native-community/datetimepicker"
import { useState } from "react"
import { View } from "react-native"
import { Button, IconButton, TextInput } from "react-native-paper"

export default function CreateStudentInfoExpense({ navigation, route }) {
	...
	const handleCreateExpense = () => {
		...
		createExpense(data.user.uid, studentKey, income)
		navigation.goBack()
	}
	...
	return (
		<View className="gap-2 flex-1 my-auto mx-auto w-[90%]">
			...
			<Button className="py-2" onPress={handleCreateExpense}>
        Adicionar
			</Button>
		</View>
	)
